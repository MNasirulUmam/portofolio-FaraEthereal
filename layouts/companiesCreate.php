<?php 
    ...
    $result = mysqli_query($koneksi,$querycompanies);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="companiesCreate.php" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label class="form-label">Name</label>
                                    <input type="text" class="form-control" id="" value="<?php echo $data['name']?>">
                                    <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Tagline</label>
                                    <input type="text" class="form-control" id="" value="<?php echo $data['tagline']?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Address</label>
                                    <input type="text" class="form-control" id="" value="<?php echo $data['address']?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Sosial</label>
                                    <input type="text" class="form-control" id="" value="<?php echo $data['sosial']?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Phone</label>
                                    <input type="text" class="form-control" id="" value="<?php echo $data['phone']?>">
                                </div>
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Logo</label>
                                    <input accept="image/*" name="logo" class="form-control" type='file' id="logo" />
                                    <br>
                                    <img id="blah" src="#" value="<?php echo $data['logo']?>" width='100' alt="your image" />
                                </div>
